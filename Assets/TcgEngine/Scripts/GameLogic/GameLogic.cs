...
namespace TcgEngine.Gameplay
{
    ...
    public class GameLogic
    {
        ...
        public virtual void StartGame()
        {
            ...
            //Get the turn Count
            int currentTurnCount = game_data.turn_count;
            ...
            foreach (Player player in game_data.players)
            {
                ...
                Debug.Log("Current Turn Count: " + currentTurnCount);

                //Hp / mana
                player.hp_max = pdeck != null ? pdeck.start_hp : GameplayData.Get().hp_start;
                player.hp = player.hp_max;
                
                //set the turn count equal to mana
                player.mana_max = pdeck != null ? pdeck.start_mana : currentTurnCount;
                player.mana = currentTurnCount;
