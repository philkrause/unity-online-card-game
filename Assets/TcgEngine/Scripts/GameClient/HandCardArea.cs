...
namespace TcgEngine.Client
{
    ...
    public class HandCardArea : MonoBehaviour
    {
        ...
        public float card_spacing = 80f;
        public float card_angle = 0f;
        ...
        void Update()
        {
            ...
            {
                card.deck_position = new Vector2((index - count_half) * 100, (index - count_half) * (index - count_half) * -card_offset_y);
