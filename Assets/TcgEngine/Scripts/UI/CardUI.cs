...
namespace TcgEngine.UI
{
    ...
    public class CardUI : MonoBehaviour, IPointerClickHandler
    {
        ...
        public void SetCard(CardData card, VariantData variant)
        {
            ...
            if(name_image != null){
                name_image.sprite = card.GetNameArt(variant);
            }
            if (frame_image != null)
        ...
        public void SetOpacity(float opacity)
        {
            ...
            if (name_image != null)
                name_image.color = new Color(name_image.color.r, name_image.color.g, name_image.color.b, opacity);
            if (frame_image != null)
